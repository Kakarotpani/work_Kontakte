...
class Company(models.Model):
    ...
    cname = models.CharField(max_length = 60, null = False, blank = False)    
    ...
    estd = models.PositiveSmallIntegerField( help_text = "(yyyy)",
            validators=[
...
class Seeker(models.Model):
    ...
    issued_id = models.CharField(max_length = 20, blank=False, null=False, help_text = '(National Identity)')
